...
class Player(object):
    ...
    IPROPERTIES         = "org.freedesktop.DBus.Array"
    ...
    def get_dbus_interface(self, wait=False):
        ...
        retry = Retry(retries=retry_count, delay=5, exp_bkf=False, final_exc=PlayerError('vlc is not running'))
    ...
    def clear(self):
        ...
        for track_id in tracks:
            self._tracklist.RemoveTrack(track_id)
